...
= 0.4.4 =
* Added upgraded features in site layout section, header section, social media section, and post section.
...
* Resolved css for upgrade pro button in about shopfront ecommerce.
...
* Added copyright color, title color, description color and list color in footer section.
* Update demo import.
...
* Resolved css error in sticky header responsive media.
* Updated woocommerce.
* Update POT file.
...
Slider Image, Copyright katik08 Photografia
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/744550

Slider Image, Copyright katik08 Photografia
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/99764
