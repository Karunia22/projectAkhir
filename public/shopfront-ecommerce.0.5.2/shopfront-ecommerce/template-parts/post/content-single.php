...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-post'); ?>>
    ...
    <?php if ('post' == get_post_type()) : ?>
        <div class="postmeta">
            <?php if (get_theme_mod('shopfront_ecommerce_single_post_date', true)) : ?>
              <div class="post-date">
                  <i class="fas fa-calendar-alt"></i> &nbsp;<?php echo esc_html($shopfront_ecommerce_post_date); ?>
              </div>
            <?php endif; ?>
            <?php if (get_theme_mod('shopfront_ecommerce_single_post_comment', true)) : ?>
              <div class="post-comment">&nbsp; &nbsp;
                <span><?php echo esc_html(get_theme_mod('shopfront_ecommerce_single_post_metabox_seperator', '|'));?></span>
                <i class="fa fa-comment"></i> &nbsp; <?php comments_number(); ?>
              </div>
            <?php endif; ?>
            <?php if (get_theme_mod('shopfront_ecommerce_single_post_author', true)) : ?>
                <div class="post-author">&nbsp; &nbsp;
                    <span><?php echo esc_html(get_theme_mod('shopfront_ecommerce_single_post_metabox_seperator', '|'));?></span>
                    <i class="fas fa-user"></i> &nbsp; <?php echo esc_html($shopfront_ecommerce_author_name); ?>
                </div>
            <?php endif; ?>
            <?php if (get_theme_mod('shopfront_ecommerce_single_post_time', true)) : ?>
                <div class="post-time">&nbsp; &nbsp;
                    <span><?php echo esc_html(get_theme_mod('shopfront_ecommerce_single_post_metabox_seperator', '|'));?></span>
